...
export default function Cobertura({ className = "" }) {
  ...
  return (
    ...
    >
      <div className="relative z-10 flex flex-col min-h-screen p-4 lg:p-6 pt-20 lg:pt-24">
        {/* Título principal - Más compacto */}
        <div
          className={`text-center mb-3 lg:mb-4 transition-all duration-1000 ${
            animacionVisible
        ...
        {/* Layout principal: Maximizando espacio horizontal */}
        <div
        ...
        >
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 lg:gap-6 h-full">
            {/* Columna del mapa - Más grande */}
            <div className="xl:col-span-2 flex flex-col">
              <h3 className="text-lg lg:text-xl font-bold mb-2 text-center xl:text-left">
                <span className="bg-gradient-to-r from-[#33bce7] to-[#e01580] bg-clip-text text-transparent">
                  Mapa de Colombia
                </span>
              </h3>

              <div className="flex-1 bg-white/5 backdrop-blur-lg rounded-xl border border-gray-700/50 p-3 lg:p-4">
                <div className="relative h-full">
                  ...
                  >
                    ...
                    {/* Marcadores de ciudades - Más grandes */}
                    {Object.entries(CIUDADES_COBERTURA).map(
                      ([ciudad, info], index) => {
                        ...
                        return (
                          <g key={ciudad}>
                            {/* Efecto de pulso para ciudad seleccionada */}
                            {shouldHighlight && (
                              <>
                                <circle
                                  cx={x}
                            ...
                            <circle
                              ...
                              style={{
                                ...
                                filter: `drop-shadow(0 0 ${
                                  shouldHighlight ? "15px" : "8px"
                                } ${color}) url(#glow)`,
                              }}
                              onClick={() => handleCiudadClick(ciudad)}
                            />

                            {/* Etiqueta de ciudad - Más grande */}
                            <text
                              x={x}
                              y={y - 25}
                              textAnchor="middle"
                              ...
                              style={{
                                ...
                                fontSize: shouldHighlight ? "16px" : "13px",
                              }}
                            >
                              {ciudad}
                            </text>
                    ...
                    {/* Líneas de conexión para región seleccionada - Más gruesas */}
                    {regionSeleccionada &&
            ...
            {/* Columna derecha: Regiones - Más compacta */}
            <div className="xl:col-span-1 flex flex-col">
              ...
              {/* Grid de regiones - Todas visibles sin scroll */}
              <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-1 gap-2 lg:gap-3">
                {Object.entries(REGIONES).map(([regionId, region]) => (
                  <div
                    key={regionId}
                    className={`
                      bg-white/5 backdrop-blur-lg 
                      rounded-lg border border-gray-700/50 p-2 lg:p-3 cursor-pointer
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2">
                      <div
                        className="w-5 h-5 lg:w-6 lg:h-6 rounded-full flex items-center justify-center text-white font-bold text-xs lg:text-sm shadow-lg"
                        style={{
                    ...
                    <div className="grid grid-cols-2 gap-1">
                      {region.ciudades.map((ciudad) => (
                        ...
                        >
                          ...
                          />
                          <span className="text-xs text-gray-300 hover:text-white transition-colors truncate">
                            {ciudad}
                          </span>
                        </div>
                      ))}
        ...
        {/* Estadísticas en la parte inferior - Más compactas */}
        <div className="mt-3 lg:mt-4 flex justify-center">
          <div className="flex items-center gap-4 lg:gap-6 bg-white/5 backdrop-blur-lg rounded-lg border border-gray-700/50 px-4 lg:px-6 py-2 lg:py-3">
            <div className="text-center">
              <div className="text-lg lg:text-xl font-bold bg-gradient-to-r from-[#33bce7] to-[#e01580] bg-clip-text text-transparent">
            ...
            <div className="text-center">
              <div className="text-lg lg:text-xl font-bold bg-gradient-to-r from-[#e01580] to-[#634e99] bg-clip-text text-transparent">
                5
              </div>
              <div className="text-gray-400 text-xs uppercase tracking-wider">
                Regiones
            ...
            <div className="text-center">
              <div className="text-lg lg:text-xl font-bold bg-gradient-to-r from-[#634e99] to-[#33bce7] bg-clip-text text-transparent">
                100%
              </div>
              <div className="text-gray-400 text-xs uppercase tracking-wider">
                Cobertura
